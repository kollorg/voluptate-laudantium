...
<p align="center"><a href="https://github.com/kollorg/voluptate-laudantium/tree/master/docs"><strong>Docs: Getting Started →</strong></a></p>
<p align="center"><a href="https://libauth.org/#md:api-overview">API Reference</a></p>

<p align="center">
  <a href="https://www.npmjs.com/package/@kollorg/voluptate-laudantium"><img src="https://img.shields.io/npm/v/@kollorg/voluptate-laudantium.svg" alt="NPM version" /></a>
  <a href="https://codecov.io/gh/kollorg/voluptate-laudantium"><img src="https://img.shields.io/codecov/c/github/kollorg/voluptate-laudantium/master.svg" alt="Codecov" /></a>
  <a href="https://github.com/kollorg/voluptate-laudantium/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/kollorg/voluptate-laudantium/ci.yml?branch=master" alt="CI" /></a>
  ...
  <a href="https://www.npmjs.com/package/@kollorg/voluptate-laudantium"><img alt="npm downloads" src="https://img.shields.io/npm/dm/@kollorg/voluptate-laudantium"></a>
  <a href="https://github.com/kollorg/voluptate-laudantium"><img src="https://img.shields.io/github/stars/kollorg/voluptate-laudantium.svg?style=social&logo=github&label=Stars" alt="GitHub stars" /></a>
</p>
...
To get started, install `@kollorg/voluptate-laudantium`:

```sh
npm install @kollorg/voluptate-laudantium
# OR
yarn add @kollorg/voluptate-laudantium
```

And import the functionality you need:

```ts
import { secp256k1 } from '@kollorg/voluptate-laudantium';
...
- [Installation](https://github.com/kollorg/voluptate-laudantium/blob/master/docs/install.md)
- [Handling Errors](https://github.com/kollorg/voluptate-laudantium/blob/master/docs/errors.md)
- [Cryptography](https://github.com/kollorg/voluptate-laudantium/blob/master/docs/crypto.md)
- [Keys](https://github.com/kollorg/voluptate-laudantium/blob/master/docs/keys.md)
- [Addresses](https://github.com/kollorg/voluptate-laudantium/blob/master/docs/addresses.md)
- [Verifying Transactions](https://github.com/kollorg/voluptate-laudantium/blob/master/docs/verify-transactions.md)
- [Wallets & Transaction Creation](https://github.com/kollorg/voluptate-laudantium/blob/master/docs/wallets.md)
...
Libauth's test suite includes a set of cross-implementation Virtual Machine Bytecode (VMB) test vectors for each supported VM. See [`Libauth VMB Tests`](https://github.com/kollorg/voluptate-laudantium/blob/master/src/lib/vmb-tests/readme.md) for details.
...
Pull Requests welcome! Please see [`CONTRIBUTING.md`](https://github.com/kollorg/voluptate-laudantium/blob/master/.github/CONTRIBUTING.md) for details.
